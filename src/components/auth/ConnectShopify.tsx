    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-purple-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">ProMotionAI</h1>
        ...
        <div className="bg-gray-900 rounded-2xl shadow-xl p-8 border border-gray-800">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-700 rounded-lg bg-gray-800 text-white placeholder-gray-500 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                />
          ...
          <div className="mt-6 pt-6 border-t border-gray-800">
            <h3 className="font-medium text-white mb-3">What you'll get:</h3>
